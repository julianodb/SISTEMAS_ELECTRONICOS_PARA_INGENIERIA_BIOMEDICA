...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T4_trigger.png" width="400">

Figura ss: Circuito del generador de pulso conectado al comparador
...
6. Como discutido anterioremente, para que el comparador produzca un voltaje positivo en su salida es necesario conectar una resistencia de pull-up hacia +5V ($R_{31}$ en la figura ss). Elijan un valor de $R_{31}$ que cumpla con los siguientes requerimientos: (0.5pt)
...
Figura ddd: Circuito de encendido/apagado con conexión de auto-apagado.
...
8. Diseñen un circuito utilizando apenas resistencias con valores disponibles en el anexo que produzca un voltaje cercano a $V_{REF}$, con una tolerancia de 5%. Utilicen hasta 8 resistencias, que pueden tener valores distintos o que se repitan entre sí para lograr dicho objetivo. Asegurense que la corriente que fluye a través del circuito diseñado es inferior a $100\ \mu A$. (0.5pt)
