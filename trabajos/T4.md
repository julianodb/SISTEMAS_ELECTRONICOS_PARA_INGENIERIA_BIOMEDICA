...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/xxx.png" width="200">
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/dsdsfds.png" width="200">

Figura 4: Integrador con RESET

El transistor $Q_{11}$ estará en modo activo mientras el voltaje en $C_4$ sea mayor que su $V_{CE_{SAT}}$. Durante dicho período, la corriente a través de $Q_{11}$ será constante e igual a $\beta I_B$. Por lo tanto, podemos reemplazar $Q_{11}$ por una fuente de corriente de la siguiente forma: 

<img src="https://julianodb.github.io/electronic_circuits_diagrams/dsdsfds.png" width="200">

Figura 5: Integrador con RESET (fuente de corriente en vez de $Q_{11}$)

3. Considerando que el voltaje inicial en $C_4$ es 5V, elijan un valor de $I_{C}$ de tal forma que $v_o(t)$ baja a 0V en $100\ \mu s$. (0.5pt)
...
Como la unión base-emisor de $Q_9$ actúa como un diodo, esto significa que sigue la ecuación de Shockley y, por lo tanto, para cada $V_{BE}$ produce un determinado $I_B$. Pero como podemos determinar con exactitud el valor de $V_{BE}$ que produce el $I_B$ que genera el $I_9$ que queremos ? Una forma práctica de hacerlo es utilizando un segundo transistor, idéntico a $Q_9$ conectado de la siguiente forma:
