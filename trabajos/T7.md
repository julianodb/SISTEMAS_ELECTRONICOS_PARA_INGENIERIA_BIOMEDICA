...
2. Elijan valores disponibles en el anexo para $R_{35}$ y $C_8$ de tal forma que el circuito a continuación implementa un filtro pasa alta con frecuencia de corte 0.3 Hz. (0.5pt)

<img src="https://julianodb.github.io/electronic_circuits_diagrams/T7_RC_highpass.png" width="250">
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T7_RC_lowpass.png" width="250">
...
4. Determine la función de transferencia del circuito a continuación y muestre que es distinta a la función de transferencia del circuito de la figura 3 multiplicada por la función de transferencia del circuito de la figura 4 (0.5pt)

<img src="https://julianodb.github.io/electronic_circuits_diagrams/T7_RC_bandpass.png" width="400">
...
5. Elijan $R_{33}$ y $R_{34} de tal forma que la ganancia maxima del circuito de la figura 7 sea aproximadamente 100. Además, calculen la función de transferencia final $H(s) = \frac{V_{in}}{V_{out}}$ y determinen sus frecuencias de corte. (1pt)
...
El valor promedio de la señal de la figura 8 es:
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T7_sallen_key_low_2.png" width="350">

Figura 9: Circuito del filtro paso baja.

La idea es que el filtro atenúa la parte de la señal que es variable en el tiempo, y por otro lado permite que el valor DC (promedio) se refleje en la salida inalterado. 
