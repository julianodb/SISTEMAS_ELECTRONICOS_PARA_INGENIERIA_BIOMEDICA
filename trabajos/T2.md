...
1. Elijan un valor de $R_{24}$ y $R_{25}$ de tal forma que la corriente de saturación de ambos transistores esté entre $50\ \mu A$ y $200\ \mu A$ (1pt)

2. Elijan un valor de $R_{26}$ y $R_{27}$ de tal forma que cuando uno de los transsitores está cortado, el otro esté saturado con $\beta_{forzado} \approx 10$ (1pt)
