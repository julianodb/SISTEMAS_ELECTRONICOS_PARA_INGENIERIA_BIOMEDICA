...
5. Elijan un valor para $R_{14}$ de tal forma que la corriente que pasa por este está entre $50\ \mu A$ y $500\ \mu A$ cuando $V_{out}=1\ V$. El valor elegido debe ser uno de los valores disponibles en el anexo. (0.5pt)

6. Elijan un valor de $C_3$ de tal forma que la respuesta calculada en el ítem 1 ($V_{out}(t)$) se mantiene por sobre 2 V durante al menos 1 ms, y como máximo por 10 ms. (0.5pt)
