...
4. Determinen la respuesta del circuito ($V_{out}$) para una entrada escalón de amplitud 5 V ($V_{in}$), en función a $R_15$ y $C_5$. 
...
7. Elijan el valor de $R_{16}$ de tal forma que el transistor está saturado cuando la corriente de base es igual a la corriente elegida en el ítem 5. (0.5pt)
