...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T8_multivibrator.png" width="350">
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T8_trigger1.png" width="500">
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T8_trigger2.png" width="500">

Figura 4: Gatillo con $Q_7$ y $R_{17}$

3. Considerando que la corriente de colector de saturación de $Q_7$ es igual al valor encontrado el pregunta 2, elijan $R_{17}$ de tal forma que (1pt):
   - $ \beta_{forzado} \approx 10$ cuando $V_{out} \approx -2.5\ V$
