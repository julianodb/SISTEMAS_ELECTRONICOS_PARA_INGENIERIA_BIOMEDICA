...
2. Analicen el siguiente circuito y elijan los valores de $R_7$ y $R_8$ de tal forma que si $v_i < 0$, $v_x = 0$ y si $v_i > 0$, $v_x = -v_i$. Los valores elegidos deben estar disponibles en el anexo y ser mayores o iguales a $10\ k\Omega$. (1.5pt)
