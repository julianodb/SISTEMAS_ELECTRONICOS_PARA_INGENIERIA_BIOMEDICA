...
1. auto-apagado después de un tiempo ajustable de hasta aproximadamente 5 minutos.
...
3. Cálculo del valor de la resistencia $R_{12}$ para que el LED se encienda con una corriente equivalente a una décima de la de prueba $I_f$ de su datasheet ($I_{R_{12}} = I_f / 10$). (0.5pt)
1. Para este proyecto, los valores de resistencia disponibles están limitados a los indicados en la tabla anexa. Elección del valor de resistencia cercano al calculado, y en cuanto cambia cada $I_f$. Este será el valor que se utilizará en el prototipo. (0.5pt)
...
6. Considerando los resultados obtenidos, estimen cuanta corriente consume cada LED del display, y cual sería el consumo maximo de corriente cuando están todos los LEDs encendidos. (1 pt) AYUDA: además del consumo de corriente de los LEDs, es posible que exista un consumo de corriente constante de los circuitos de control.

## 3. Ajustes de los Parametros

### 3.1 Ajuste de temperatura alta y baja
...
Figura X: Circuito para permitir el ajuste de un voltaje $V_o$ entre 0 y 5 V.

Se disponen de potenciometros con los valores indicados en la segunda tabla anexa.

7. Elijan el valor de potenciometro a utilizar considerando que cada uno consuma una corriente menor o igual a $100\ \mu A$. (0.5 pt)

### 3.2 Ajuste de criterio de estabilidad
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/resistance_potentiometer_5V.png" width="70">

8. Elijan el valor de $R_{pot}$ y $R_{21}$ considerando los siguientes requerimientos (1pt):
   - La corriente por las resistencias es menor a $100\ \mu A$
   - El valor de $R_{pot}$ es uno de los valores disponibles en la segunda tabla anexa
   - El valor de $R_{21}$ es uno de los valores disponibles en la tabla anexa
   - El valor máximo de $V_o$ está entre 150 mV y 250 mV

### 3.3 Ajuste de tiempo de auto-apagado
...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/potentiometer_resistance_5V.png" width="70">

8. Elijan el valor de $R_{pot}$, $R_{21}$ y $V_{REF}$ considerando los siguientes requerimientos (1pt):
...
Valores de Potenciometros disponibles:
