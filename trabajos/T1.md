...
7. Elijan el valor de potenciometro a utilizar considerando que cada uno consuma una corriente menor o igual a $100\ \mu A$. El valor elegido debe ser uno de los valores en la segunda tabla anexa. (0.5 pt)
...
8. Elijan el valor de $R_{pot2}$ y $R_{22}$ considerando los siguientes requerimientos (1pt):
