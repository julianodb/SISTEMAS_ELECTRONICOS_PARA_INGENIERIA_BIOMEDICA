...
<img src="https://julianodb.github.io/electronic_circuits_diagrams/T5_materials3.png" width="400">
...
Como la impedancia de salida del circuito es muy alta, no se pueden conectar circuitos que consumen mucha corriente a $V_{bias\_weak}$, pues se cambiaria el valor de este. Una forma de entenderlo es considerar que al conectar una resistencia entre $V_{bias\_weak}$ y tierra, ésta apareceria en paralelo al $R_X$ inferior, disminuyendo su valor efectivo y, por lo tanto disminuyendo el valor de $V_{bias\_weak}$. Para mejorar la capacidad de la tierra virtual de entregar o consumir corrientes se utilizará un buffer, el que se muestra en la figura a continuación.
