...
1. Preparar para la fabricación de las placas en el Laboratorio 6
...
Se disponen de LEDs de 3 mm de diametro de 5 colores distintos (Rojo/Amarillo/Verde/Azul/Blanco) para cumplir la función de indicación luminosa. Estos se utilizarán tanto para mostrar que las placas están correctamente energizadas (luces de encendido), como para señalizar cada pulso cardíaco. Cada grupo utilizará LEDs con el color que equivale al nombre de su grupo para el prototipo. 
...
Para visualizar el valor de frecuencia cardíaca se utilizará un display de voltaje como el de la siguiente figura:

![T1_display](../img/T1_display.jpg)

Figura 6: Display de voltaje

Conforme discutido en el Trabajo 3, para facilitar la lectura del valor de frecuencia cardíaca apuntaremos a que 1 V del voltaje que se muestra en el display sea equivalente a una frecuencia de 100 latidos por minuto (si el display muestra 1.00, equivale a 100 lpm, si muestra 0.89 significa 89 lpm etc). 
...
9. Considerando los resultados obtenidos, estimen cual sería el consumo maximo de corriente cuando todos los LEDs del display están encendidos. (0.5pt)

## 4. Preparación para la fabricación

10. Preparen una Lista de Materiales (BOM) con el valor de todos los componentes elegidos hasta el momento. Asergúrense de utilizar los valores corregidos de cada uno de ellos. Separen la BOM en una lista para la "Placa 1" y otra para la Placa 2", utilizando las siguientes figuras como referencia de qué componente se utiliza en qué placa: (0.5pt)

<img src="https://julianodb.github.io/electronic_circuits_diagrams/T5_stethoscope_board_1_so_far.png" width="800">

Figura 9: Circuito de la Placa 1 del estetoscopio electrónico hasta el Trabajo 5

<img src="https://julianodb.github.io/electronic_circuits_diagrams/T5_stethoscope_board_2_so_far.png" width="800">

Figura 10: Circuito de la Placa 2 del estetoscopio electrónico hasta el Trabajo 5

## Plazo de entrega: 23:59, 26 de Noviembre de 2025
