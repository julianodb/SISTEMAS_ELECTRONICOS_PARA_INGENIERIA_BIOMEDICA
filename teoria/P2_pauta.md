...
1. Para el circuito de la Figura 1, determine $v_o$ y el calor entregado a la incubadora por $R_{heat}$ si la temperatura es (2pt):
    1. 33 °C (+0.75pt)
        > $v_{temp} = 400\ mV + 33*19.5\ mV = 1043.5\ mV $ (+0.1pt)
        >
        > $v_{set} = 1080\ mV > v_{temp}$
        >
        > Como $v_{set} > v_{temp} \implies v_{+} > v_{-}$. Asumiendo un amplificador operacional ideal, la salida seria $+\infty$ (+0.1pt). En la realidad, se satura en el voltaje de alimentación positivo, $V_{CC}$. 
        >
        > Por lo tanto, $v_o = V_{CC} = 5\ V$. (+0.1pt)
        >
        > Como la unión base-emisor de Q está polarizada en directa, se asume $V_{BE} = 0.7\ V$.
        >
        > Por lo tanto, la corriente en la base de Q es $I_B = \frac{v_o-V_{BE}}{R_B} = \frac{5-0.7}{680} \approx 6.3\ mA$ (+0.1pt)
        >
        > Para calcular la potencia en $R_{heat}$, se debe descubrir si Q está actuando en modo activo o saturado. (+0.15pt)
        >
        ...
        >
        > $\therefore I_C = \frac{V_{heat}-V_{CE}}{R_{heat}} = \frac{10-0.3}{3} \approx 3.23\ A$ (+0.1pt)
        >
        ...
        >
        > $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 3.23^2 \approx 31\ W$ (+0.1pt)
    1. 34 °C (+0.75pt)
        > $v_{temp} = 400\ mV + 34*19.5\ mV = 1063\ mV $ (+0.1pt)
        >
        > $v_{set} = 1080\ mV > v_{temp}$
        >
        > Como $v_{set} > v_{temp} \implies v_{+} > v_{-}$. Asumiendo un amplificador operacional ideal, la salida seria $+\infty$ (+0.1pt). En la realidad, se satura en el voltaje de alimentación positivo, $V_{CC}$.
        ...
        > Por lo tanto, $v_o = V_{CC} = 5\ V$. (+0.1pt)
        >
        > Como $v_o$ es el mismo del ejercício anterior, las corrientes y voltajes en el transistor serán las mismas y, por lo tanto, $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 3.23^2 \approx 31\ W$ (+0.45pt, distribuidos de la misma forma que antes)
    1. 35 °C (+0.5pt)
        > $v_{temp} = 400\ mV + 35*19.5\ mV = 1082.5\ mV $ (+0.1pt)
        >
        > $v_{set} = 1080\ mV < v_{temp}$
        >
        > Como $v_{set} < v_{temp} \implies v_{+} < v_{-}$. Asumiendo un amplificador operacional ideal, la salida seria $-\infty$ (+0.1pt). En la realidad, se satura en el voltaje de alimentación negativo.
        >
        > Por lo tanto, $v_o = tierra = 0\ V$. (+0.1pt)
        >
        > Como $V_{BE} = 0 \implies I_B = 0 \implies I_C = 0$ (+0.1pt), el calor entregado por $R_{heat}$ es:
        >
        > $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 0^2 = 0\ W$ (+0.1pt)
...
2. Para el circuito de la Figura 2, considerando el análisis en corriente contínua ($\omega=0$), determine (2pt):
    1. una fórmula para $v_o$ en función de $V_{set}$ y $v_{temp}$ en corriente contínua. (+0.5pt)
        > Para el análisis en corriente contínua, se eliminan los condensadores. Por lo tanto, el circuito sería el siguiente (+0.1pt):
        >
        ...
        > $$\begin{cases}
            V_+ = V_- & \text{(1)} & (+0.1pt)\\
            \frac{v_o-V_-}{R_2} = \frac{V_--V_{temp}}{R_1} & \text{(2)} & (+0.1pt)\\
            V_+ = \frac{R_4}{R_3+R_4}V_{set} & \text{(3)} & (+0.1pt)
            \end{cases}$$
        >
        ...
        >
        > $v_o = 47(V_{set}-V_{temp})$ (+0.1pt)
        >
        > También se podría haber encontrado $A_v(\omega)$ y reemplazado $\omega=0$ (+0.1pt)
    1. $v_o$ y el calor entregado a la incubadora por $R_{heat}$ si la temperatura es 33 °C (+0.5pt)
        > $v_{temp} = 400\ mV + 33*19.5\ mV = 1043.5\ mV $ (+0.07pt)
        >
        > $v_o = 47(V_{set} - v_{temp}) = 47(1,08 -1,0435)$ (+0.07pt)
        >
        > $v_o \approx 1.72\ V$ (+0.07pt)
        >
        > Como la unión base-emisor de Q está polarizada en directa, se asume $V_{BE} = 0.7\ V$.
        >
        > Por lo tanto, la corriente en la base de Q es $I_B = \frac{v_o-V_{BE}}{R_B} = \frac{1.72-0.7}{680} \approx 1.5\ mA$ (+0.07pt)
        >
        > Para calcular la potencia en $R_{heat}$, se debe descubrir si Q está actuando en modo activo o saturado. (+0.08pt)
        >
        > Si se asume que Q está en modo saturado:
        >
        > $V_{CE} = V_{CE_{SAT}} = 0.3\ V$
        ...
        > Si se asume que Q está en modo activo:
        >
        > $I_C = \beta I_B = 1000*1.5\ mA = 1.5\ A$ (+0.07pt)
        >
        > Comprobando el criterio de modo activo ( $V_{CE}> V_{CE_{SAT}}$ ):
        >
        ...
        > Finalmente, el calor entregado por $R_{heat}$ es:
        >
        > $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 1.5^2 = 6.75\ W$ (+0.07pt)
    1. $v_o$ y el calor entregado a la incubadora por $R_{heat}$ si la temperatura es 34 °C (+0.5pt)
        > $v_{temp} = 400\ mV + 34*19.5\ mV = 1063\ mV $ (+0.07pt)
        >
        > $v_o = 47(V_{set} - v_{temp}) = 47(1,08 -1,063)$ (+0.07pt)
        >
        > $v_o = 0.799\ V$ (+0.07pt)
        >
        > Como la unión base-emisor de Q está polarizada en directa, se asume $V_{BE} = 0.7\ V$.
        >
        > Por lo tanto, la corriente en la base de Q es $I_B = \frac{v_o-V_{BE}}{R_B} = \frac{0.799-0.7}{680} \approx 146\ \mu A$ (+0.07pt)
        >
        > Para calcular la potencia en $R_{heat}$, se debe descubrir si Q está actuando en modo activo o saturado. (+0.08pt)
        >
        > Si se asume que Q está en modo saturado:
        ...
        > Si se asume que Q está en modo activo:
        >
        > $I_C = \beta I_B = 1000*146\ \mu A = 146\ mA$ (+0.07pt)
        >
        > Comprobando el criterio de modo activo ( $V_{CE}> V_{CE_{SAT}}$ ):
        >
        ...
        > Finalmente, el calor entregado por $R_{heat}$ es:
        >
        > $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 0.146^2 \approx 64\ mW$ (+0.07pt)
    1. $v_o$ y el calor entregado a la incubadora por $R_{heat}$ si la temperatura es 35 °C (+0.5pt)
        > $v_{temp} = 400\ mV + 35*19.5\ mV = 1082.5\ mV $ (+0.1pt) 
        >
        > $v_o = 47(V_{set} - v_{temp}) = 47(1,08 -1,0825)$ (+0.1pt) 
        >
        > $v_o = -0.1175\ V$
        >
        > Como el amplificador operacional está alimentado por $V_{CC} = 5\ V$ y $tierra = 0\ V$, el menor voltaje de salida posible es 0 V.
        >
        > Por lo tanto, $v_o = 0\ V$. (+0.1pt)
        >
        > Como $V_{BE} = 0 \implies I_B = 0 \implies I_C = 0$ (+0.1pt), el calor entregado por $R_{heat}$ es:
        >
        > $Calor_{R_{heat}} = R_{heat} I_C^2 = 3* 0^2 = 0\ W$ (+0.1pt) 
...
2. Para el circuito de la Figura 2, considerando el análisis en frecuencia, determine (2pt):
    1. la ganancia de voltaje del circuito amplificador en función de la frecuencia ($A_{V}(\omega)$). Considere que el voltaje de salida es $v_o$ y que el voltaje de entrada es $v_i=V_{set}-v_{temp}$. (+0.5pt)
        ...
        > $$\begin{cases}
            V_+ = V_- & \text{(1)} & (+0.07pt) \\
            \frac{v_o-V_-}{R_2// Z_{C_1}} = \frac{V_--V_{temp}}{R_1} & \text{(2)} & (+0.07pt)\\
            V_+ = \frac{R_4//Z_{C_2}}{R_3+R_4//Z_{C_2}}V_{set} & \text{(3)} & (+0.07pt)
            \end{cases}$$
        >
        ...
        >
        > Reemplazando $Z_{C_1} = \frac{1}{C_1 s}$ y $V_{set}-V_{temp} = v_i$ (+0.07pt)
        >
        ...
        >
        > $H(s) = \frac{R_2}{R_1}\frac{1}{1+R_2 C_1 s} $ (+0.08pt)
        >
        ...
        >
        > $A_v(\omega) = \frac{R_2}{R_1}\frac{1}{\sqrt{1+(R_2 C_1 \omega)^2}}$ (+0.07pt)
        >
        > Reemplazando $R_2 = 47\ k\Omega$, $R_1 = 1\ k\Omega$ y $C_1 = 47\ \mu F$,
        >
        > $A_v(\omega) \approx 47\frac{1}{\sqrt{1+(2.2 \omega)^2}}$ (+0.07pt)
    2. el tipo de filtro (pasobaja, pasoalta, pasobanda) (+0.5pt)
        > La ganancia del circuito disminuye conforme aumenta la frecuencia. Por lo tanto, se trata e un filtro pasobaja
    3. la frecuencia de corte en Hz. Asuma que la ganancia maxima es $\frac{R_2}{R_1}$. (+0.5pt)
        ...
        >
        > $47\frac{1}{\sqrt{1+(2.2* 2\pi f_c)^2}} = \frac{47}{\sqrt{2}}$ (+0.25pt)
        >
        > $1+(4.4\pi f_c)^2 = 2$
        >
        > $(4.4\pi f_c)^2 = 1$
