...
2. La actividad eléctrica del corazón se compone de corrientes eléctricas que fluyen en determinadas direcciones. Si los electrodos del ECG están alineados con la corriente eléctrica, se produce una diferencia de voltaje entre ellos. Si, por otro lado, la corriente fluye en una dirección perpendicular a la línea que une los electrodos, no se detecta diferencia de voltajes. Considerando esto, se utilizan electrodos en distintas posiciones para medir la actividad eléctrica del corazón. La siguiente figura muestra la ubicación estándar de los electrodos para un ECG que utiliza 4 electrodos.
...
3. Es muy común que la señal de ECG contengaPara el circuito de la Figura 5, asumiendo que $R_1=R_2=3.3\ k\Omega$ y $C_1=C_2=3.3\ nF$ determine:
