...
La Figura 3 muestra el circuito del multivibrador monoestable a ser implementado, donde $v_i = v_{pletis}$ es la señal de salida del amplificador 2. Este circuito 
