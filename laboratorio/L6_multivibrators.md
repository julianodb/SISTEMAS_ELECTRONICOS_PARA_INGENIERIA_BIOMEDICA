...
- Osciloscopio, Fuente CC., 2x Cable Banana-Caimán, 1x Sonda
- botón / pulsador
- cables, alicate, etc
- Placa de Circuito Impreso "Lab M"
...
1. Dibujen un diagrama del circuito, incluyendo donde está el jumper y el valor de los componentes. (1.5 pt)
    ...
    AYUDA: Las imágenes en anexo muestran el diseño de la placa utilizada y cómo está conectado el amplificador operacional de los circuitos integrados IC1 y IC2.
...
![top](../img/lab_multivibrator_top.png)

Figura 1: Diseño de la placa utilizada (top)

![bot](../img/lab_multivibrator_bot.png)

Figura 2: Diseño de la placa utilizada (bottom)

![lmv321](../img/lmv321.png)

Figura 3: Pinout del LMV321 (vista superior)