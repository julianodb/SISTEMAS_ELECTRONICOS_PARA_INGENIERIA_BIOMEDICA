...
6. Identifiquen en el protoboard el circuito de la Figura 3. Conecten el multímetro conforme indicado. Midan la corriente inversa. Puede ser necesario ajustar la escala de corriente para obtener una medida. (10 ptos.)
...
7. Con el mismo diodo de la medición anterior, armen el circuito de la Figura 4. Pueden desarmar el circuito de la Figura 3 para lograrlo. Usen una frecuencia de 50 Hz, y un voltaje de 3 Vpp sin offset. Vean las señales en modo XY. Guarden en un pendrive los datos de esta medición.
    
    1. Entreguen el pendrive al profesor, junto con la medición de la corriente reversa obtenida en el punto anterior. Estimen los parametros de la curva del diodo ($I_S$, $n$, $V_T$) (20 ptos.)
...
8. Identifiquen en el protoboard el circuito de la Figura 5. Ajusten el potenciometro en: 0 Ω, 1 K Ω y 10 K Ω. 
